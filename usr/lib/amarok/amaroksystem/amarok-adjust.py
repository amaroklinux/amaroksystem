...
TIMESTAMPS = "/var/log/amaroksystem.timestamps"
...
class amarokSystem():
    ...
    def __init__(self):
        ...
        self.logfile = open("/var/log/amaroksystem.log", "w")
        self.time_log("amarokSystem started")
        self.executed = []
        self.overwritten = []
        self.skipped = []
        self.edited = []
    ...
    def adjust(self):
        try:
            ...
            try:
                ...
                config.read('/etc/amarok/amarokSystem.conf')
                ...
                with open('/etc/amarok/amarokSystem.conf', 'w') as configfile:
            ...
            adjustment_directory = "/usr/share/amarok/adjustments/"
